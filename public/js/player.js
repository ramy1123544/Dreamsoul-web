...
function renderPlayer(d, id) {
  ...
  // الأفاتار — Discord CDN (لازم هاش الأفاتار الحقيقي، مو نص حرفي)
  const avatarEl = document.getElementById('p-avatar');
  avatarEl.src = d.avatar
    ? `https://cdn.discordapp.com/avatars/${id}/${d.avatar}.png?size=128`
    : `https://cdn.discordapp.com/embed/avatars/${parseInt(id) % 5}.png`;
  avatarEl.onerror = () => {
    avatarEl.onerror = null; // يمنع حلقة لا نهائية لو فشل حتى الاحتياطي
